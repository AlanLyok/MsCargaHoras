-- Ejemplos:
-- EXEC dbo.AGLTRAC_ObtenerTareasAsignadas @Filtro='alan', @Fuente='TRAC';
-- EXEC dbo.AGLTRAC_ObtenerTareasAsignadas @Filtro='113',  @Fuente='ACT';
-- EXEC dbo.AGLTRAC_ObtenerTareasAsignadas @Filtro='alan', @Fuente='TODOS';

ALTER PROC dbo.AGLTRAC_ObtenerTareasAsignadas
...
BEGIN
  ...
  -- Armo selección final según @Fuente
  ...
  -- Dinámico: defino ambas CTE y después selecciono según @Fuente
  SET @sql = N'
  ;WITH T_TRAC AS (
    SELECT
