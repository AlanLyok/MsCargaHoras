...
setlocal
set SCRIPT_DIR=%~dp0
set BUILD_PS1=%SCRIPT_DIR%Build-Run-MsCargaHoras.ps1
...
start "Watch MsCargaHoras" powershell -NoProfile -ExecutionPolicy Bypass -File "%BUILD_PS1%" -Configuration Debug -Port 58755 -ReuseIIS -Watch -AutoFix -MaxAttempts 3 -LogFile "%SCRIPT_DIR%msbuild-last.log"
